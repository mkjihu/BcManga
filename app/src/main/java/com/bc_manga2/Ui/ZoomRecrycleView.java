 ...
 */
public class ZoomRecrycleView extends RecyclerView {
    ...
    public ZoomRecrycleView(Context context) {
        super(context);
    ...
    public ZoomRecrycleView(Context context, AttributeSet attr) {
        super(context, attr);
        this.context = context;
        mScaleDetector = new ScaleGestureDetector(context, new ScaleListener());
        initGestureDetector(getContext());
    ...
    private void initGestureDetector(Context context) {
		this.mGestureDetector = new GestureDetector(getContext(),new scrollReaderViewGestureListener());
    }
