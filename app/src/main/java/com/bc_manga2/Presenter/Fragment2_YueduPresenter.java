...
import com.bc_manga2.Fragment.Fragment2_Yuedu;
...
public class Fragment2_YueduPresenter extends BasePresenter<Fragment2_Yuedu> {

	public Fragment2_YueduPresenter(Fragment2_Yuedu view) {
		super(view);
	}

	public void GetYueduAdapder()
	{
		Disposable d = Observable.just("")
				...
				.map(new Function<String,Adapter<ViewHolder>>() {
					...
					public Adapter<ViewHolder> apply(String arg0) throws Exception {
						...
						List<BcIndexData> bcIndexDatas = bcIndexDataDao.queryBuilder().orderDesc(Properties.ClickDate).limit(200).list();//-前200條
