...
public class SortFineItem {
	...
	/**預設宣告方式 --不用特殊手段*/
	public SortFineItem(String Image,String Name,String Url) 
	{
		setImage(Image);
		setName(Name);
		setUrl(Url);
	...
	public SortFineItem(String Image,String Name,String Url,boolean SpecialType) 
	{
		setImage(Image);
		setName(Name);
		setUrl(Url);
	...
	/**指定解析方式 SpecialType == 1為要二度解析*/
	public SortFineItem(String HomePK,String Image,String Name,String Url,boolean SpecialType) 
	{
		setHomePK(HomePK);
		setImage(Image);
		setName(Name);
